...
Современная многостраничная информационная система для управления объектами недвижимости и оформления сделок купли-продажи. Проект разработан в рамках курсовой работы по дисциплине "Проектирование и разработка информационных систем".
